...
async def code_script(ticker) : 
    ...
    Pkey = 'f2vHhCkaQp8wyDTUpmHU3V1isXiz9i2P3ETRrccagSNjKNTBINnSc1OjGHuuDS82'
    Skey = 'Xjx47kKNs5bdYlOqgiy9ELd4GljTMNZIlL39UTNN5EXKISbtf3bGUO4M6ZOp4sk3'    
...
tickers = ['FILUSDT','FIOUSDT','FIROUSDT','FISUSDT','FLMUSDT','FLOWUSDT','FLUXUSDT','FORTHUSDT','FORUSDT','FRONTUSDT','FTMUSDT','FTTUSDT','FUNUSDT','FXSUSDT','GALAUSDT','GALUSDT','GBPUSDT','GHSTUSDT','GLMRUSDT','GMTUSDT','GNOUSDT','GRTUSDT','GTCUSDT','GTOUSDT','HARDUSDT','HBARUSDT','HIGHUSDT','HIVEUSDT','HNTUSDT','HOTUSDT','ICPUSDT','ICXUSDT','IDEXUSDT','ILVUSDT','IMXUSDT','INJUSDT','IOSTUSDT','IOTAUSDT','IOTXUSDT','IRISUSDT','JASMYUSDT','JOEUSDT','JSTUSDT','JUVUSDT','KAVAUSDT','KDAUSDT','KEYUSDT','KLAYUSDT','KMDUSDT','KNCUSDT','KP3RUSDT','KSMUSDT','LAZIOUSDT','LDOUSDT','LINAUSDT','LINKUSDT','LITUSDT','LOKAUSDT','LPTUSDT','LRCUSDT','LSKUSDT','LTCUSDT','LTOUSDT','LUNAUSDT','MANAUSDT','MASKUSDT','MATICUSDT','MBLUSDT','MBOXUSDT','MCUSDT','MDTUSDT','MDXUSDT','MFTUSDT','MINAUSDT','MIRUSDT','MITHUSDT','MKRUSDT','MLNUSDT','MOBUSDT','MOVRUSDT','MTLUSDT','MULTIUSDT','NBSUSDT','NEARUSDT','NEOUSDT','NEXOUSDT','NKNUSDT','NMRUSDT','NULSUSDT','OCEANUSDT','OGNUSDT','OGUSDT','OMGUSDT','OMUSDT','ONEUSDT','ONGUSDT','ONTUSDT','OOKIUSDT','ORNUSDT','OXTUSDT','PAXGUSDT']  
