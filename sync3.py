...
async def code_script(ticker) : 
    ...
    Pkey = 'BQixsRUhCiM8bz7x4J0gaF91OFatuFCNIsbdA6GY9dyU4yIkV74cjvuAPf3xdQSG'
    Skey = 'WUduXyEqwJaGM9JdyN6Z1m8kafcjeodEHFug68BO5eP32kjb2qUxKxEeu8wun6oh'    
    ...
    if not df_60.empty: 
        ...
        peak_max_60=df_60.iloc[a]
            ...
            # le pfoint de corde sur les 1min
...
tickers = ['PEOPLEUSDT','PERLUSDT','PERPUSDT','PHAUSDT','PLAUSDT','PNTUSDT','POLSUSDT','POLYUSDT','PONDUSDT','PORTOUSDT','POWRUSDT','PSGUSDT','PUNDIXUSDT','PYRUSDT','QIUSDT','QNTUSDT','QTUMUSDT','QUICKUSDT','RADUSDT','RAMPUSDT','RAREUSDT','RAYUSDT','REEFUSDT','REIUSDT','RENUSDT','REPUSDT','REQUSDT','RIFUSDT','RLCUSDT','RNDRUSDT','ROSEUSDT','RSRUSDT','RUNEUSDT','RVNUSDT','SANDUSDT','SANTOSUSDT','SCRTUSDT','SCUSDT','SFPUSDT','SHIBUSDT','SKLUSDT','SLPUSDT','SNXUSDT','SOLUSDT','SPELLUSDT','SRMUSDT','STEEMUSDT','STMXUSDT','STORJUSDT','STPTUSDT','STRAXUSDT','STXUSDT','SUNUSDT','SUPERUSDT','SUSHIUSDT','SXPUSDT','SYSUSDT','TCTUSDT','TFUELUSDT','THETAUSDT','TKOUSDT','TLMUSDT','TOMOUSDT','TORNUSDT','TRBUSDT','TRIBEUSDT','TROYUSDT','TRUUSDT','TRXUSDT','TUSDT','TVKUSDT','TWTUSDT','UMAUSDT','UNFIUSDT','UNIUSDT', 'UTKUSDT','VETUSDT','VGXUSDT','VIDTUSDT','VITEUSDT','VOXELUSDT','VTHOUSDT','WANUSDT','WAVESUSDT','WAXPUSDT','WINGUSDT','WINUSDT','WNXMUSDT','WOOUSDT','WRXUSDT','WTCUSDT','XECUSDT','XEMUSDT','XLMUSDT','XNOUSDT','XRPUSDT','XTZUSDT','XVGUSDT','XVSUSDT','YFIIUSDT','YFIUSDT','YGGUSDT','ZECUSDT','ZENUSDT','ZILUSDT','ZRXUSDT']  
